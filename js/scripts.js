...
(function(){
    ...
    (function(){
        ...
        function getQuoteLite(indx) {
            return dLite[index];
        }
        function getQuoteMini(indx) {
            return dMini[index];
        }
        function getQuoteUni(indx) {
            return dUni[index];
        }
        function getQuoteLux(indx) {
            return dLux[index];
        }
        ...
        function renderPrices() {
            document.getElementById("Price_1_1_1").innerHTML = getQuotesLite(iLite);
            document.getElementById("Price_1_1_2").innerHTML = getQuotesLite(iLite);
            document.getElementById("Price_1_1_3").innerHTML = getQuotesLite(iLite);
            document.getElementById("Price_1_2_1").innerHTML = getQuotesMini(iMini);
            document.getElementById("Price_1_2_2").innerHTML = getQuotesMini(iMini);
            document.getElementById("Price_1_2_3").innerHTML = getQuotesMini(iMini);
            document.getElementById("Price_1_3_1").innerHTML = getQuotesUni(iUni);
            document.getElementById("Price_1_3_2").innerHTML = getQuotesUni(iUni);
            document.getElementById("Price_1_3_3").innerHTML = getQuotesUni(iUni);
            document.getElementById("Price_1_4_1").innerHTML = getQuotesLux(iLux);
            document.getElementById("Price_1_4_2").innerHTML = getQuotesLux(iLux);
            document.getElementById("Price_1_4_3").innerHTML = getQuotesLux(iLux);
        }
        function readInput_single() {
            var some_var;
            if (document.getElementById("width_1").value) some_var = document.getElementById(someVar);
        }
